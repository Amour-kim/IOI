...
const MaintenancePage = () => {
  ...
  // Domaines d'expertise pour la Maintenance
  const domains = [
    {
      icon: Shield,
      title: 'Maintenance Préventive',
      description: "Surveillance proactive, mises à jour, prévention des pannes.",
    ...
    },
    {
      ...
      description: "Dépannage rapide, résolution d’incidents, support technique 24/7.",
    ...
    },
    {
      icon: Users,
      title: 'Infogérance',
      description: "Gestion complète de votre parc informatique, serveurs, réseaux.",
    ...
    },
    {
      ...
      description: "Protection des données, sauvegardes, plans de reprise d’activité.",
    ...
    },
    {
      ...
      description: "Surveillance en temps réel, alertes, reporting.",
    ...
    },
    {
      ...
      description: "Hotline, prise en main à distance, formation utilisateurs.",
  ...
  // Étapes d'approche pour la Maintenance
  const approachSteps = [
    {
      icon: Target,
      title: 'Audit & Diagnostic',
      description: "État des lieux, identification des risques, plan d’action.",
      color: 'from-blue-400 to-green-500'
    },
    {
      icon: Lightbulb,
      title: 'Mise en Place',
      description: "Déploiement des outils de supervision, configuration des alertes.",
      color: 'from-yellow-400 to-orange-500'
    },
    {
      icon: CheckCircle,
      title: 'Surveillance & Intervention',
      description: "Monitoring continu, interventions préventives et curatives.",
      color: 'from-orange-400 to-red-500'
    },
    {
      icon: TrendingUp,
      title: 'Reporting & Amélioration',
      description: "Rapports réguliers, recommandations, amélioration continue.",
      color: 'from-blue-400 to-purple-500'
    }
  ];
  ...
  const experts = [
    {
      ...
      expertise: 'Supervision, monitoring, sécurité',
      color: 'from-blue-400 to-green-500',
      rating: 4.9
    },
    {
      ...
      expertise: 'Dépannage, assistance utilisateur',
      color: 'from-orange-400 to-red-500',
      rating: 4.8
    },
    {
      name: 'Amadou Diop',
      role: 'Expert Infogérance',
      expertise: 'Gestion de parc, serveurs, réseaux',
      color: 'from-green-400 to-blue-600',
      rating: 4.9
    },
    {
      ...
      expertise: 'Sauvegarde, PRA, cybersécurité',
      color: 'from-blue-400 to-purple-500',
      rating: 4.7
    }
  ];

  // Témoignages Maintenance
  const testimonials = [
    {
      name: 'Sophie Martin',
      role: 'Dirigeante PME',
      text: "Depuis la mise en place de la maintenance IOI, nos incidents ont chuté de 80%. Service réactif et pro !",
      rating: 5
    },
    {
      name: 'Lucas Morel',
      role: 'DSI, GroupeX',
      text: "L’infogérance nous a permis de nous concentrer sur notre cœur de métier. Support très disponible.",
      rating: 5
    },
    {
      name: 'Marie Dupont',
      role: 'Responsable RH',
      text: "La hotline IOI a résolu tous nos soucis informatiques rapidement. Merci à l’équipe !",
      rating: 5
    }
  ];

  // Cas d'usage Maintenance
  const caseStudies = [
    {
      icon: Shield,
      industry: 'Santé',
      title: 'Sécurisation des données patients',
      challenge: 'Respect du RGPD et zéro perte de données',
      solution: 'Sauvegardes automatisées, PRA',
    ...
    },
    {
      icon: BarChart3,
      industry: 'Industrie',
      title: 'Supervision 24/7 du SI',
      challenge: 'Réduire les interruptions de service',
      solution: 'Monitoring, alertes, interventions proactives',
      result: '-90% d’incidents critiques',
      color: 'from-yellow-400 to-orange-500',
      bgColor: 'bg-yellow-50'
    },
    {
      icon: Award,
      industry: 'Services',
      title: 'Assistance utilisateurs multi-sites',
      challenge: 'Support rapide pour 500 collaborateurs',
      solution: 'Hotline, prise en main à distance',
  ...
  const faqs = [
    {
      ...
      answer: "Oui, notre équipe intervient à distance ou sur site à toute heure."
    },
    {
      question: "Quels types d’incidents couvrez-vous ?",
      answer: "Pannes, virus, perte de données, problèmes réseau, etc."
    },
    {
      question: "Peut-on externaliser toute la gestion informatique ?",
      answer: "Oui, nous proposons des offres d’infogérance complète."
    },
    {
      question: "Comment garantissez-vous la sécurité ?",
      answer: "Sauvegardes, chiffrement, audits réguliers, PRA."
    },
    {
      question: "Avez-vous des engagements de délai ?",
      answer: "Nos SLA garantissent des délais d’intervention rapides."
    },
    {
      question: "Formez-vous les utilisateurs ?",
      answer: "Oui, nous proposons des sessions de formation et sensibilisation."
    }
  ];

  // Outils/technos Maintenance
  const tools = [
    { name: 'Nagios', icon: BarChart3, color: 'from-yellow-400 to-orange-500' },
    { name: 'TeamViewer', icon: Award, color: 'from-orange-400 to-pink-500' },
    { name: 'Veeam', icon: Shield, color: 'from-blue-400 to-green-500' },
    { name: 'GLPI', icon: Users, color: 'from-green-400 to-blue-600' },
    { name: 'Zabbix', icon: Globe, color: 'from-blue-400 to-purple-500' },
    { name: 'AnyDesk', icon: Zap, color: 'from-orange-400 to-red-500' }
  ];

  const techs = [
    { name: 'Nagios', logo: '/tech/nagios.png' },
    { name: 'TeamViewer', logo: '/tech/teamviewer.png' },
    { name: 'Veeam', logo: '/tech/veeam.png' },
    { name: 'GLPI', logo: '/tech/glpi.png' },
    { name: 'Zabbix', logo: '/tech/zabbix.png' },
    { name: 'AnyDesk', logo: '/tech/anydesk.png' }
  ];
          ...
          <div className={`flex flex-col md:flex-row items-center gap-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}> 
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-xl sm:text-2xl text-blue-100 max-w-xl mb-6">
                Expertise en maintenance informatique et support technique pour votre entreprise
              </p>
              <div className="flex flex-wrap gap-3 mb-8">
                {['Maintenance', 'Support', 'Infogérance', 'Sécurité', 'Monitoring', 'Hotline'].map((mot, i) => (
