...
const FormationPage = () => {
  ...
  // Domaines d'expertise pour la Formation
  const domains = [
    {
      icon: Users,
      title: 'Formations Présentielles',
      description: "Sessions en salle, ateliers interactifs, pédagogie active.",
    ...
    },
    {
      ...
      description: "Modules en ligne, classes virtuelles, parcours hybrides.",
    ...
    },
    {
      ...
      description: "Accompagnement individuel, développement de compétences clés.",
    ...
    },
    {
      ...
      description: "Préparation et passage de certifications reconnues.",
    ...
    },
    {
      ...
      description: "Évaluation, orientation et plan de développement personnalisé.",
    ...
    },
    {
      icon: Zap,
      title: 'Soft Skills',
      description: "Communication, leadership, gestion du stress, créativité.",
  ...
  // Étapes d'approche pour la Formation
  const approachSteps = [
    {
      icon: Target,
      title: 'Diagnostic & Analyse',
      description: "Identification des besoins, évaluation des compétences, définition des objectifs.",
      color: 'from-blue-400 to-green-500'
    },
    {
      icon: Lightbulb,
      title: 'Conception du Parcours',
      description: "Élaboration du programme, choix des modalités, création des supports.",
      color: 'from-yellow-400 to-orange-500'
    },
    {
      icon: CheckCircle,
      title: 'Animation & Suivi',
      description: "Animation des sessions, accompagnement, évaluation continue.",
      color: 'from-green-400 to-blue-600'
    },
    {
      icon: TrendingUp,
      title: 'Bilan & Certification',
      description: "Évaluation finale, remise d’attestation ou de certification.",
      color: 'from-orange-400 to-pink-500'
    }
  ];
  ...
  const experts = [
    {
      ...
      expertise: 'Pédagogie active, soft skills',
      color: 'from-blue-400 to-green-500',
      rating: 4.9
    },
    {
      ...
      expertise: 'Coaching, bilan de compétences',
      color: 'from-green-400 to-blue-600',
      rating: 4.8
    },
    {
      name: 'Julie Chen',
      role: 'Experte E-learning',
      expertise: 'Digital learning, blended, LMS',
      color: 'from-yellow-400 to-orange-500',
      rating: 4.9
    },
    {
      name: 'Lucas Morel',
      role: 'Consultant Certification',
      expertise: 'Certifications, ingénierie pédagogique',
      color: 'from-orange-400 to-pink-500',
      rating: 4.7
    }
  ];
  ...
  const testimonials = [
    {
      name: 'Sophie Martin',
      role: 'RH, EntrepriseX',
      text: "Des formations concrètes, interactives et adaptées à nos besoins. Les équipes sont montées en compétences !",
      rating: 5
    },
    {
      name: 'Fatou Ndiaye',
      role: 'Manager, StartUpY',
      text: "Le coaching individuel a boosté ma confiance et mon efficacité au travail.",
      rating: 5
    },
    {
      name: 'Pierre Martin',
      role: 'Responsable Formation, GroupeZ',
      text: "Le blended learning a permis de former tout le personnel à distance, avec un excellent taux de réussite.",
      rating: 5
    }
  ];
  ...
  const caseStudies = [
    {
      icon: Users,
      industry: 'Industrie',
      title: 'Formation sécurité en présentiel',
      challenge: 'Respect des normes et implication des équipes',
      solution: 'Ateliers interactifs, cas pratiques',
      result: '100% de conformité',
      color: 'from-blue-400 to-green-500',
      bgColor: 'bg-blue-50'
    },
    {
      icon: Globe,
      industry: 'Tech',
      title: 'Parcours e-learning sur mesure',
      challenge: 'Former à distance des équipes internationales',
      solution: 'Modules en ligne, classes virtuelles',
      result: '+95% de taux de complétion',
      color: 'from-green-400 to-blue-600',
      bgColor: 'bg-green-50'
    },
    {
      ...
      challenge: 'Valoriser les compétences des managers',
      solution: 'Préparation à la certification, coaching',
      result: '80% de réussite à l’examen',
      color: 'from-orange-400 to-pink-500',
      bgColor: 'bg-orange-50'
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Oui, nous proposons des parcours 100% en ligne ou hybrides."
    },
    {
      question: "Les formations sont-elles certifiantes ?",
      answer: "Certaines formations préparent à des certifications reconnues."
    },
    {
      question: "Proposez-vous des bilans de compétences ?",
      answer: "Oui, nous accompagnons l’orientation et la reconversion professionnelle."
    },
    {
      question: "Comment mesurez-vous la progression ?",
      answer: "Évaluations, quiz, mises en situation, feedbacks réguliers."
    },
    {
      question: "Peut-on personnaliser le programme ?",
      answer: "Chaque parcours est adapté à vos besoins et objectifs."
    },
    {
      question: "Avez-vous des financements possibles ?",
      answer: "Nous vous aidons à mobiliser les dispositifs de financement (OPCO, CPF, etc.)."
    }
  ];

  // Outils/technos Formation
  const tools = [
    { name: 'Zoom', icon: Globe, color: 'from-blue-400 to-green-500' },
    { name: 'Moodle', icon: Users, color: 'from-green-400 to-blue-600' },
    { name: 'Teams', icon: Lightbulb, color: 'from-yellow-400 to-orange-500' },
    { name: 'Kahoot', icon: Award, color: 'from-orange-400 to-pink-500' },
    { name: 'Google Classroom', icon: BarChart3, color: 'from-blue-400 to-purple-500' },
    { name: 'Mentimeter', icon: Zap, color: 'from-green-400 to-yellow-500' }
  ];

  const techs = [
    { name: 'Zoom', logo: '/tech/zoom.png' },
    { name: 'Moodle', logo: '/tech/moodle.png' },
    { name: 'Teams', logo: '/tech/teams.png' },
    { name: 'Kahoot', logo: '/tech/kahoot.png' },
    { name: 'Google Classroom', logo: '/tech/google-classroom.png' },
    { name: 'Mentimeter', logo: '/tech/mentimeter.png' }
  ];
          ...
          <div className={`flex flex-col md:flex-row items-center gap-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}> 
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-xl sm:text-2xl text-blue-100 max-w-xl mb-6">
                Expertise en formation professionnelle et développement personnel
              </p>
              <div className="flex flex-wrap gap-3 mb-8">
                {['Formation', 'E-learning', 'Coaching', 'Certification', 'Soft Skills', 'Bilan'].map((mot, i) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { number: '100+', label: 'Formations proposées', color: 'text-blue-500' },
              { number: '5+', label: 'Années d\'expérience', color: 'text-green-500' },
              { number: '99%', label: 'Taux de satisfaction', color: 'text-blue-600' },
              { number: '500+', label: 'Participants accompagnés', color: 'text-green-600' }
            ].map((stat, index) => (
